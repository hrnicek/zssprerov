...
use App\Http\Controllers\PrintMenuController;
...
Route::get('/jidelnicky', [MenuController::class, 'index'])->name('menu');
Route::get('/jidelnicky/tisk', [PrintMenuController::class, 'index'])->name('menu.print');
